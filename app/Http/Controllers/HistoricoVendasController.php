...
class HistoricoVendasController extends StandardController
{
    protected $model;
    protected $nameView = 'dashboard.historicovendas';
    protected $data;
    protected $title = ' Histórico de Vendas';
...
//        dd($data);
    ...
    public function retornaApostaPremios($idven, $idbase, $idreven, $datmov){
     ...
     //   $datfim = date ("Y/m/d");
      ...
      AND APOSTA_PALPITES.DATLIBPRE = '$datmov'
...
//        dd($valor);
    $data = DB::select(
       "SELECT EXTRACT(month FROM RESUMO_CAIXA.DATMOV) AS MES,
       ...
       GROUP BY EXTRACT(month FROM RESUMO_CAIXA.DATMOV),RESUMO_CAIXA.IDBASE,RESUMO_CAIXA.IDVEN,RESUMO_CAIXA.IDREVEN,REVENDEDOR.NOMREVEN
