...
@section('content')
                                                            ...
                                                            <td>
                                                              @if($lv->sitlig == 'ATIVO')
                                                                 @php
                                                                    $ope = 'INATIVO';
                                                                 @endphp  
                                                                <a href="/admin/revendedor/l/{{$dados->idbase}}/{{$dados->idven}}/{{$dados->idreven}}/{{$lv->idlot}}/{{$ope}}" class="waves-effect waves-light btn-small">INATIVAR</a>  
                                                              @else
                                                                 @php
                                                                    $ope = 'ATIVO';
                                                                 @endphp            
                                                                <a href="/admin/revendedor/l/{{$dados->idbase}}/{{$dados->idven}}/{{$dados->idreven}}/{{$lv->idlot}}/{{$ope}}" class="waves-effect waves-light btn-small green-text text-darken-2 ">ATIVAR</a>  
                                                              @endif
    ...
    {{-- Modal altera Limite--}}
    <div id="modallimite" class="modal modal-pequeno" >

            <div class="right-align">
                    <a href="#!" class=" btn modal-action modal-close waves-effect waves-light red "><i class=" Tiny material-icons">close</i></a>
            </div>
            <div class="row">
                <div class="input-field col s10 m10 l10 center-align">
                        <h4>Alterar Limite Crédito Revendedor</h4>
    ...
    <div id="modalComissao" class="modal modal-pequeno" >
...
//        $('#limlibpre').mask('000.000.000.000.000,00', {reverse: true});
        ...
        $(".submit").on("click", function(){
            $(window.top.document).find('#myModal').dialog('close');
});
