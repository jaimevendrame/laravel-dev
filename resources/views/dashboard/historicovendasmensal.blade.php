    ...
    <div class="section">
        <div class="row">
            <div class="col s12">
                        ...
                        <form class="form-group" id="form-cad-edit" method="post" action="/admin/historicovendasmensal/{{$p_ideven}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        ...
                        <table class="mdl-data-table" id="example" cellspacing="0" width="100%">
                            ...
                            <td>  
                                    @php
                                   $descricaoMes = $resumo->datmov;
                                   $descricaoAno = $resumo->datmovano;
                                   $mesNum = substr($descricaoAno,0,2);
                                   $anoNum = substr($descricaoAno,2,6);
                                   switch ($descricaoMes) {
                                         case '1':                                        
                                            echo '01-JAN ';
                                            echo $anoNum ;
                                       ...
                                       <div id="{{$resumo->vlrdevatu}}" class="modal modal2">
                                           <div class="modal-content">
                                               ...
                                               <div class="video-container">
                                                    <iframe width="700" height="315" src="/admin/historicovendasmensal/aposta_premiada/{{$resumo->idven}}/{{$resumo->idbase}}/{{$resumo->idreven}}/
                                                    {{$resumo->datmovano}}/{{$resumo->datmov}}" frameborder="0" allowfullscreen></iframe>
                                                </div>
                                               </p>
