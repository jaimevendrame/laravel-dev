        ...
        <div class="row">
            <div class="col s12">
                    ...
                    {{ csrf_field() }}
                        ...
                        <form class="form-group" id="form-cad-edit" method="post" action="/admin/apostas/{{$bases->ideven}}" enctype="multipart/form-data">
            ...
            <div class="row">
                @php
                    ...
                    foreach ($data as $key){
                        ...
                        if ($key->sitapo == 'I'){
                            $totalInstantanea += $key->vlrpalp;
                        }
                    }

                @endphp
                
                    <div class="col s12 m2 l2 blue-grey darken-3 center-align">  
                        <h5 class="white-text">Total Pules Válidas:&nbsp;&nbsp;&nbsp; @php echo number_format($totalPulesValido + $totalInstantanea, 2, ',', '.'); @endphp</h5>    
                    </div>     
            </div>
        </div>
